...
public final class SitaApiSoap_SitaApiSoap12_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        {
        System.out.println("Invoking getMessagesOfIncident...");
        int _getMessagesOfIncident_incident = 0;
        DirectionType _getMessagesOfIncident_directionOfMessages = null;
        ArrayOfMessage _getMessagesOfIncident__return = port.getMessagesOfIncident(_getMessagesOfIncident_incident, _getMessagesOfIncident_directionOfMessages);
        System.out.println("getMessagesOfIncident.result=" + _getMessagesOfIncident__return);
        ...
        java.lang.String _sendMessageWithMedia_title = "";
        ArrayOfInt _sendMessageWithMedia_mediaIds = null;
        boolean _sendMessageWithMedia__return = port.sendMessageWithMedia(_sendMessageWithMedia_token, _sendMessageWithMedia_teamId, _sendMessageWithMedia_description, _sendMessageWithMedia_title, _sendMessageWithMedia_mediaIds);
        ...
        java.lang.String _sendMessage_title = "";
        boolean _sendMessage__return = port.sendMessage(_sendMessage_token, _sendMessage_teamId, _sendMessage_description, _sendMessage_title);
